...
public class Patch extends HttpServlet {
    //private final TokenManager manager = new TokenManager("E:\\tinyThings\\Source Packages\\tiny.properties");
     ...
     */
        ...
        if(moveOn){
            ...
            URL postUrl = new URL(Constant.RERUM_API_ADDR + "/patch.action");
